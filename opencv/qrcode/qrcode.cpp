...
static int  liveQRCodeDetect(const std::string& out_file);
static int  imageQRCodeDetect(const std::string& in_file, const std::string& out_file);
...
void drawQRCodeContour(cv::Mat &color_image, std::vector<cv::Point> transform)
{
    using namespace std;
    using namespace cv;
...
int liveQRCodeDetect(const std::string& out_file)
{
    using namespace std;
    using namespace cv;
...
int imageQRCodeDetect(const std::string& in_file, const std::string& out_file)
{
    using namespace std;
    using namespace cv;
